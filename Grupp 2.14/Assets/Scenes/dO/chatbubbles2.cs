...
public class chatbubbles2 : MonoBehaviour
{
    ...
    [Header("Conversation")]
    [SerializeField] private List<ChatMessage2> conversation = new List<ChatMessage2>();
    ...
    void StartConversation()
    {
        ...
        Debug.Log("StartConversation börjar");
    ...
    IEnumerator DisplayConversation()
    {
        ...
        {
            var chatMessage2 = conversation[i];

            // Type out the message
            isTyping = true;
            skipTypingRequested = false;
            yield return TypeText(messageText, chatMessage2.message);
            isTyping = false;
            ...
            {
                yield return new WaitForSeconds(chatMessage2.delayAfterMessage);
            }
